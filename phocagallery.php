...
class PlgFinderPhocagallery extends FinderIndexerAdapter
{
	protected $context 			= 'Phocagallery';
	protected $extension 		= 'com_phocagallery';
	protected $layout 			= 'category';
	protected $type_title 		= 'Phoca Gallery';
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->addTaxonomy('Type', 'Phoca Gallery');
